...
namespace CalculatorProject.InterfaceExample
{
    public class Principal
    {
        ...
        //Instanciamos dos clases del tipo ave pasando de parametro el nombre del ave
            ...
            //Polimorfismo de Interfaz -- Solo abstraes los metodos de esta interfaz
            IVehiculo coche = new Coche();
            coche.Arrancar();
            coche.Parar();
            //coche.Clone(); Error --- No puedes acceder a los metodos de otras clases.

            ICloneable cloneable = new Coche();
            cloneable.Clone(); //--> ahora puedes acceder a este metodo.
